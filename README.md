...
## 👥 Authors
* **Hiya Kashyap** - (Chitkara University)
* **Shivi** - (Chitkara University)
* **Under the Guidance of Mentor:** **Rajat Takkar**

* ## 📂 Project Structure
* **`reserchpaper/`**: Contains the final research paper PDF (Preprint).
...
The positive criticisms made by him have added to the richness and value of our work. We are also grateful to all the researchers who have made significant contributions to our field of study and have published various works that are instrumental in gaining an insight into the psychological impact of artificial intelligence implementation in the health and wellness industry.

*© 2026 Hiya Kashyap, Shivi & Rajat Takkar.*
